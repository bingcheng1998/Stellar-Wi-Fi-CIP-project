...
public class ColorPickerActivity extends AppCompatActivity implements ColorPicker.OnColorChangedListener {
    ...
    private Button button, broadcast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opacityBar.setOnOpacityChangedListener(new OpacityBar.OnOpacityChangedListener() {
            ...
            public void onOpacityChanged(int opacity) {
                ...
                List<Light> lights = ColorPickerActivity.this.lights;
    ...
    public void sendBroadcast() {
        localApiService.scanDevices(WifiUtils.getBroadcastAddress(this).getAddress(), 2000).enqueue(new Callback<List<Light>>() {
            ...
            public void onResponse(List<Light> lights) {
                ColorPickerActivity.this.lights.clear();
                if (!lights.isEmpty()) {
                    ColorPickerActivity.this.lights.addAll(lights);
                }
                L.e("搜索到设备个数：" + lights.size());
                Toast.makeText(ColorPickerActivity.this, "搜索到设备" + lights.size() + "个",
