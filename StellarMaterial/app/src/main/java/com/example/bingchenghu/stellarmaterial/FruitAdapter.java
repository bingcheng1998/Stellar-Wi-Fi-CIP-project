...
/**
 * Created by bingchenghu on 2018/3/22.
 */
...
//                intent.putExtra(PatternActivity.FRUIT_NAME,fruit.getName());
//                intent.putExtra(PatternActivity.FRUIT_IMAGE_ID,fruit.getImageId());
//                mContext.startActivity(intent);
                //-----------------------------------------------------------------------
            }
        });
